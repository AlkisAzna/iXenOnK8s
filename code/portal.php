...
//   $Sub_paylaod= $_POST['checkbox'];
  ...
  //echo "User: ".$USERNAME."<br><br><br>";
    ...
    header("Location: http://10.124.0.3/index.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;background-color: DodgerBlue!important;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="devPortal.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Developers</a>
    <a href="ConPortal.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Customers</a>
    <a href="index.php" onclick="logout()" class="w3-bar-item w3-button w3-hover-white"style="position:absolute; bottom:0;width:90%; overflow: hidden;">Logout</a>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>Iot Platform</b></h1>
    <h1 class="w3-xxxlarge w3-text-red"style="color: DodgerBlue!important;"><b>Concept.</b></h1>
  </div>
  ...
  <div class="w3-container" id="services" style="margin-top:75px;">
    <h1 class="w3-xxxlarge w3-text-red"style="color: DodgerBlue!important;"><b>Developers.</b></h1>
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"style="color: DodgerBlue!important;"><b>Customers.</b></h1>
    <hr style="width:50px;border:5px solid DodgerBlue" class="w3-round">
...
function logout(){
  ...
  xhttp.open("POST", "Destroy_session.php", true);
  xhttp.send();
